...
Common excuses for skipping verification gates, with rebuttals. When a rationalization forms, stop and follow the gate.

| Rationalization | Rebuttal |
|----------------|----------|
| "This change is too small to test" | Small changes cause the most insidious bugs. If it's small, the test is small too. |
| "I'll write the tests after" | Tests written after implementation verify what was written, not what is needed. They miss edge cases by design. |
