---
name: playwright
description: Playwright MCP reference for browser automation. Consult when taking screenshots, testing forms, or running E2E flows. Contains tool names, viewports, and workflow patterns.
---

# Playwright MCP Reference

Reference guide for browser automation via Playwright MCP tools.
