...
The project plan becomes the foundation for **feature planning** (`/feature-define`) and **implementation planning** (`pre-plan`).
...
- **Keep implementation out of it.** This is project-level thinking. "We'll use PostgreSQL" is a project decision. "The users table will have these columns" is implementation — save it for feature-define or pre-plan.
